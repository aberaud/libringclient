...
public:
   ...
   static const TypedStateMachine< TypedStateMachine< ActionStatfulnessLevel , SelectionState             > , UserActionModel::Action > actionStatefulness;
...
#define ST ActionStatfulnessLevel::
const TypedStateMachine< TypedStateMachine< UserActionModelPrivate::ActionStatfulnessLevel , UserActionModelPrivate::SelectionState > , UserActionModel::Action > UserActionModelPrivate::actionStatefulness = {{
   /*                           NONE         UNIQUE             MULTI     */
...
Qt::ItemFlags UserActionModel::flags(const QModelIndex& idx ) const
{
   ...
   return (d_ptr->m_CurrentActions[action] ? (Qt::ItemIsEnabled | Qt::ItemIsSelectable) : Qt::NoItemFlags)
      | (d_ptr->actionStatefulness[action][d_ptr->m_SelectionState] == UserActionModelPrivate::ActionStatfulnessLevel::CHECKABLE
